    ...
    const signUpData = await SignUp(values)
      if (signUpData?.success) {
         toast("SignUp successfully ",{
          description:"you have successfully create your account",
    ...
    <div className="flex flex-col w-full lg:w-4/6  items-center max-lg:h-fit h-full border rounded-md shadow px-10 py-10 shadow-gray-200 ">
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex w-full flex-col gap-5  ">
        <div className="flex flex-col w-full items-center                             .  ">
            ...
            <p className="font-medium">Create yours account</p>
-        </div>
      ...
      <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Enter Fullname" {...field} className="form-input" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
    ...
    <div className="flex flex-col gap-5">
       ...
       <div className="flex gap-3 font-medium text-xs mt-3">
         <p>have an account ? </p>
         <Link href="/sign-in" className="text-blue-500 cursor-pointer">Login</Link>
       </div>
      </div>
    </Form>
</div>
